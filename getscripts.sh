...
wget https://raw.githubusercontent.com/peterwup/myproxmox/main/cleanup.sh -O ~/cleanup.sh --backups=0 -O /usr/local/bin/vzdump-hook-script-with --backups=0
wget https://raw.githubusercontent.com/peterwup/myproxmox/main/vzdump-hook-script-with 
#
