...
wget https://raw.githubusercontent.com/peterwup/myproxmox/main/trilium-hook-script --backups=0 -O /var/lib/vz/snippets/trilium-hook-script
#
...
chmod a+x /var/lib/vz/snippets/trilium-hook-script
#
